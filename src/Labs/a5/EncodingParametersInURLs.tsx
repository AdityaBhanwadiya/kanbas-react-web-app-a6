...
function EncodingParametersInURLs() {
    ...
    return (
        <div>
            ...
            <a className="btn btn-primary m-2 p-2" href={`${API_BASE}/a5/add/${a}/${b}`}>
                Add {a} + {b}
            </a>
            <a className="btn btn-danger p-2" href={`${API_BASE}/a5/subtract/${a}/${b}`}>
                Substract {a} - {b}
            </a>
            <h3>Query Parameters</h3>
            <a className="btn btn-primary m-2 p-2"
